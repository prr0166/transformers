    ...
    def test_small_logits_batch(self):
        ...
        EXPECTED_LOGITS = torch.tensor(
            [
                ...
                [-10.247313499450684, -0.4237828254699707, 3.1179518699645996, -9.989541053771973, -10.001238822937012, -10.040529251098633, -9.996538162231445, -10.052029609680176, -9.986088752746582, -10.036115646362305],
                [-9.98245906829834, -1.4058563709259033, 3.539100170135498, -9.433758735656738, -9.444565773010254, -9.49752426147461, -9.452383995056152, -9.457331657409668, -9.432816505432129, -9.439447402954102],
            ]
        )
        # fmt: on
        torch.testing.assert_close(outputs.logits[0][:, :10].cpu(), EXPECTED_LOGITS, rtol=2e-4, atol=2e-4)
    ...
    def test_medium_logits_batch(self):
        ...
        EXPECTED_LOGITS = torch.tensor(
            [
                ...
                [-9.396651268005371, -0.7291030287742615, 2.298774003982544, -9.815659523010254, -9.854050636291504, -9.821599006652832, -9.81181812286377, -9.838842391967773, -9.854424476623535, -9.855895042419434],
